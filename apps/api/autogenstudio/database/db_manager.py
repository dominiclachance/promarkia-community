...
class DatabaseManager:
    ...
    def __init__(self, engine_uri: str, base_dir: Optional[Union[str, Path]] = None) -> None:
        ...
        """
        # FastAPI executes synchronous route functions in a worker thread. A
        # SQLite connection must therefore be allowed to cross thread
        # boundaries; SQLAlchemy still serializes access through its pool.
    ...
    def initialize_database(self, auto_upgrade: bool = False, force_init_alembic: bool = True) -> Response:
        ...
        try:
            ...
            existing_tables = set(tables_exist)
